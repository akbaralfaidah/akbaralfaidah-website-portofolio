          ...
          <div className="hidden md:flex items-center space-x-1 text-base font-medium text-charcoal dark:text-[#F2F0E8] bg-[#FAFAFA]/50 dark:bg-[#1A1A1C]/50 border border-charcoal/10 dark:border-white/10 px-3 py-1.5 rounded-full">
            {navItems.map((item) => (
              <a
                ...
                className="px-4 py-1.5 rounded-full transition-all duration-300 text-charcoal/80 dark:text-[#F2F0E8]/80 hover:-translate-y-1 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-brass hover:to-yellow-500 dark:hover:to-yellow-300"
              >
                {item.label}
              </a>
            ))}
